...
function Ended({event}:{event:EventState}){return <div className="empty-state"><h1>This tasting has ended.</h1><p>Guest live screens are closed. Their recaps and customer histories remain available.</p><div className="row" style={{ justifyContent:"center" }}><Link className="btn btn-primary" href={`/admin/events/${event.id}/results`}>See results</Link></div></div>}
